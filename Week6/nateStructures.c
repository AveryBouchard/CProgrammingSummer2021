...
void calculate_Overtime (struct employee emp [ ], int size);
void get_Gross (struct employee emp [ ], int size);
...
// 
// Returns: the calculated amount of hourswork over a normal work week
//  
//**************************************************************/
